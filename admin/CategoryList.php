...
<td>
<h1>Category List</h1>
<table cellpadding="3" cellspacing="0"><tr class=tblHead><td>&nbsp;</td><td>Category Name</td><td>Status</td></tr>
<?php
$sql = "SELECT * FROM categoryDetail ORDER BY CategoryName";
$result = $conn->query($sql);
while($row = $result->fetch_assoc()) 
{
	echo "<tr><td><a href=CategoryForm.php?catId=" . $row["CategoryId"] . ">Edit</a></td>";
