...
<title>Sub Category Detail</title>
<style>
.tblHead
{
...
<form action=SubCategorySave.php method="post">
<table>
...
<?php
$sql1 = "SELECT * FROM categoryDetail ORDER BY CategoryName";
...
<tr><td colspan="2" align="center"><input type="submit" value="Add Sub Category" /></td></tr>
</table>
</form>
<?php
}
elseif($id>0)
{
$sql = "SELECT * FROM SubcategoryDetail WHERE SubCatId=" . $id;
$result = $conn->query($sql);
if($row = $result->fetch_assoc()) 
{
?>
...
<table>
<tr><td>Sub Category Name</td>
<td><input type="text" maxlength="50" name="txtName" value="<?php echo $row["subCatName"] ?>" /><input type="hidden" name="txtId" value="<?php echo $row["subCatId"] ?>" /></td></tr>
...
<tr><td colspan="2" align="center"><input type="submit" value="Update Sub Category" /></td></tr>
</table>
</form>
